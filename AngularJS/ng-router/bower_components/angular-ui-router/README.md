...
---
**[Download 0.2.15](http://angular-ui.github.io/ui-router/release/angular-ui-router1.js)** (or **[Minified](http://angular-ui.github.io/ui-router/release/angular-ui-router.min.js)**) **|**
...
**(1)** Get UI-Router in one of the following ways:
 ...
 - [download the release](http://angular-ui.github.io/ui-router/release/angular-ui-router1.js) (or [minified](http://angular-ui.github.io/ui-router/release/angular-ui-router.min.js))
...
**(2)** Include `angular-ui-router1.js` (or `angular-ui-router.min.js`) in your `index.html`, after including Angular itself (For Component users: ignore this step)
