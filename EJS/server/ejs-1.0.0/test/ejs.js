...
describe('includes', function(){
  it('should include ejs', function(){
    var file = 'test/fixtures/in.ejs';
    ejs.render(fixture('in.ejs'), { filename: file, pets: users, open: '[[', close: ']]' })
  ...
  it('should pass compileDebug to include', function(){
    var file = 'test/fixtures/in.ejs';
    var fn = ejs.compile(fixture('in.ejs'), { filename: file, open: '[[', close: ']]', compileDebug: false, client: true })
    var str = fn.toString();
    eval('var preFn = ' + str);
